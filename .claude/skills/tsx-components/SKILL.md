---
name: tsx-components
description: Structure, section order, and naming conventions for TSX React components with TypeScript. Use whenever writing, editing, or reviewing a .tsx component, to keep types, state, callbacks, effects, and exports in a consistent, predictable, alphabetically-ordered structure.
---
...
> across the project. It is the TypeScript counterpart of the `jsx-components` skill —
> both share the same structure, naming conventions, and alphabetical ordering rules.
