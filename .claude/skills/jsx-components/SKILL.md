---
name: jsx-components
description: Structure, section order, and naming conventions for JSX functional components (no TypeScript) in this project. Use whenever writing, editing, or reviewing a .jsx React component, to keep imports, state, callbacks, effects, and PropTypes in a consistent, predictable order.
---
...
> of the `tsx-components` skill — both share the same structure, naming conventions,
